...
module.exports = {
  ...
  MAX_CONTENT_SIZE  : 1000000000, // Max allowed size of the http response content in bytes (1MB)

  // Constant Headers (Add Custom General Headers while initialising app)
  GENERAL_HEADERS: {},
